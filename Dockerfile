...
LABEL io.k8s.description="Platform for building and running java8 jar applications" \
      io.k8s.display-name="Java8 Jar" \
      io.openshift.expose-services="8080:http" \
      io.openshift.tags="builder,java,java8,jar."

# TODO: Install required packages here:
# Java jdk 8
RUN INSTALL_PKGS="tar unzip bc which lsof curl java-1.8.0-openjdk java-1.8.0-openjdk-devel" && \
